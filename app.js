const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: "fa-solid fa-spinner fa-spin-pulse",
            CurrentIcon: this.StandardEyeIcon, // leave this
            SuccessColor: "rgb(136, 3, 252)", // This is the color when the target has found the option
            StandardColor: "rgb(3, 148, 252)", // This is the standard color, change this to the same as the StandardColor if you have changed it
